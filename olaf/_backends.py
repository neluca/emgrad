...
CPU_BACKEND = numpy
CPU_BACKEND.set_printoptions(precision=_PRECISION, linewidth=_MAX_LINE_WIDTH, floatmode=_FLOATMODE)

try:
    import cupy

    GPU_BACKEND = cupy
    GPU_BACKEND.set_printoptions(precision=_PRECISION, linewidth=_MAX_LINE_WIDTH, floatmode=_FLOATMODE)
except ImportError:
    GPU_BACKEND = None
